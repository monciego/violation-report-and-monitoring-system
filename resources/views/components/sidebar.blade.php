            ...
            <ul class="mt-3">
                    ...
                    <div class="flex items-center">
                        <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                            <path class="fill-current
                                {{ request()->routeIs('violator.*') ? 'text-indigo-500' : 'text-gray-600' }}"
                        ...
                        <span
                            class="text-sm font-medium ml-3 lg:opacity-100 2xl:opacity-100 duration-200 {{ request()->routeIs('students.*') ? 'text-white' : 'text-gray-300' }}">
                            {{ __('Violator\'s List') }}
                        </span>
                    </div>
                </x-nav-link>
                ...
                <x-nav-link :href="route('students.index')" :active="request()->routeIs('students.*')">
                    <div class="flex items-center">
                        ...
                        <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                            <path
                                class="fill-current {{ request()->routeIs('students.*') ? 'text-indigo-500' : 'text-gray-600' }}"
                                d="M18.974 8H22a2 2 0 012 2v6h-2v5a1 1 0 01-1 1h-2a1 1 0 01-1-1v-5h-2v-6a2 2 0 012-2h.974zM20 7a2 2 0 11-.001-3.999A2 2 0 0120 7zM2.974 8H6a2 2 0 012 2v6H6v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5H0v-6a2 2 0 012-2h.974zM4 7a2 2 0 11-.001-3.999A2 2 0 014 7z" />
                            <path
                                class="fill-current {{ request()->routeIs('students.*') ? 'text-indigo-300' : 'text-gray-400' }}"
